...
namespace AutoInsuranceWinForms
{
    public class EmployeeEditForm : Form
    {
        ...
        public EmployeeEditForm(int? id)
        {
            ...
            buttons.Controls.Add(save); buttons.Controls.Add(cancel); Controls.Add(table); Controls.Add(buttons); if (id.HasValue) LoadData();
        }
